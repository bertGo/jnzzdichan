...
<link rel="stylesheet" href="<?php echo CSS_PATH;?>news-details.css" />
...
<!--      <iframe src="<?php echo APP_PATH;?>index.php?m=comment&c=index&a=init&commentid=<?php echo id_encode("content_$catid",$id,$siteid);?>&ifr=1" width="100%" height="100%" id="comment_iframe" frameborder="0" scrolling="no"></iframe>-->
<!--      <div class="box">-->
<!--        		<h5>评论排行</h5>-->
